        ...
        <div class="kozpont">
            <div class="urlapkinezet">
				...
				?>
				 ...
				 <form name="filefeltoltes" id="filefeltoltes" action="kepfeltolt.php" method="POST" enctype="multipart/form-data">
				Kép kiválasztása
	    <input type="file" name="filefeltolt" id="filefeltolt">

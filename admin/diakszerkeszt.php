    ...
    <div class="grid-kontener">
        ...
        <div class="kozpont">
            <div class="urlapkinezet">
				...
				<form action="diakmodosit.php" method="post" >
				<fieldset>
				<legend>Jelenlegi adatok</legend>
				<?php 
				$s="select diakok.oktatasi_azon, diakok.vezeteknev,diakok.keresztnev,osztalyok.kezdeseve,osztalyok.vegzeseve,osztalyok.megnevezes from diakok,osztalyok where diakok.osztalyid=osztalyok.osztalyid and diakid=".$diakid;
				$p=$conn->query($s);
				while($adatok=$p->fetch_assoc()){
					echo $adatok['vezeteknev']." ".$adatok['keresztnev']."<br>";
					echo $adatok['oktatasi_azon']."<br>";
					echo $adatok['kezdeseve']." /".$adatok['vegzeseve']." ".$adatok['megnevezes']."<br>";
				...
				<input type="hidden" name="diakid" id="diakid" value="<?php echo $diakid?>">

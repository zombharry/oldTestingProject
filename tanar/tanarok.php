        ...
        <div class="kozpont">
            <div class="urlapkinezet">
				...
				while($sor=mysqli_fetch_assoc($vegrehajtas)){
					echo "<tr>".$sor['tanarid']."</tr>";
					echo "<tr>".$sor['vezeteknev']. $sor['keresztnev']."</tr>";
					echo "<tr>".$sor['felhasznalonev']."</tr>";
					$sql2="select tantargyak.megnevezes from (tantargyak inner join kepes on tantargyak.tantargyid=kepes.tantargyid) where kepes.tanarid=".$sor['tanarid']."";
					$vegrehajtas2=$conn->query($sql2);
					echo "<tr>";
					while($tantargyak=mysqli_fetch_assoc($vegrehajtas2)){
						echo $tantargyak['megnevezes']." ;";
					}
					echo "</tr>";
				}
